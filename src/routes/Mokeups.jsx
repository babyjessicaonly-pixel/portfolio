     ...
     <div className="container d-flex justify-content-between align-items-start" style={{ maxWidth: "60rem" }}>
      ...
      <div className="container text-center p-3" style={{ maxWidth: "48rem" }}>
        <div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="carousel" data-bs-interval="10000">
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              <img src="/mockup/8.piatti/fiori_verde.jpg" className="d-block w-100" alt="..." style={{ borderRadius: "8px"}} />
            </div>
            <div className="carousel-item">
              <img src="/mockup/8.piatti/fiori_azzurri.jpg" className="d-block w-100" alt="..." style={{ borderRadius: "8px"}}/>
            </div>
            <div className="carousel-item">
              <img src="/mockup/8.piatti/fiori_blu.jpg" className="d-block w-100" alt="..." style={{ borderRadius: "8px"}}/>
            </div>
            <div className="carousel-item">
              <img src="/mockup/8.piatti/fiori_viola.jpg" className="d-block w-100" alt="..." style={{ borderRadius: "8px"}}/>
            </div>
            <div className="carousel-item">
              <img src="/mockup/8.piatti/fiori_rosa.jpg" className="d-block w-100" alt="..." style={{ borderRadius: "8px"}}/>
            </div>
            <div className="carousel-item">
              <img src="/mockup/8.piatti/fiori_arancio.jpg" className="d-block w-100" alt="..." style={{ borderRadius: "8px"}}/>
            </div>
            <div className="carousel-item">
              <img src="/mockup/8.piatti/fiori_rossi.jpg" className="d-block w-100" alt="..." style={{ borderRadius: "8px"}}/>
            </div>
          </div>
          <button className="carousel-control-prev" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide="prev">
            <span className="carousel-control-prev-icon" aria-hidden="true"></span>
